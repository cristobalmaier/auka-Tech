...
(214, 16, 14, 18, 2, '123132', '2025-07-08 21:07:26', 1, 0),
(215, 16, 14, 14, 2, 'asdads213123', '2025-07-08 22:16:46', 1, 0);
...
(1, 'Baja', 'Una situación sin urgencia que puede resolverse cuando haya disponibilidad.'),
(2, 'Media', 'Requiere atención en el día porque puede afectar la comodidad o la productividad, pero no impide el funcionamiento general.'),
(3, 'Alta', 'Interfiere directamente con el trabajo y debe resolverse lo antes posible para evitar pérdidas o interrupciones graves.');
...
--
-- Volcado de datos para la tabla `respuestas_llamados`
--

INSERT INTO `respuestas_llamados` (`id_respuesta`, `id_llamado`, `mensaje`, `id_preceptor`, `fecha_respuesta`) VALUES
(156, 214, 'En camino', 16, '2025-07-08 18:07:37'),
(157, 215, 'En camino', 16, '2025-07-08 19:57:20');
...
--
ALTER TABLE `llamados`
  MODIFY `id_llamado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=216;

--
-- AUTO_INCREMENT de la tabla `respuestas_llamados`
--
ALTER TABLE `respuestas_llamados`
  MODIFY `id_respuesta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;
